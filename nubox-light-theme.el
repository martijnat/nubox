...
(orange2 nubox_faded_orange)
    ...
    (custom-theme-set-faces
     ...
     `(eshell-ls-special ((t (:foreground ,orange2))))
     ...
     `(font-lock-builtin-face ((t (:foreground ,orange2))))
     ...
     `(outline-2  ((t (:weight bold :foreground ,cyan))))
     `(outline-3  ((t (:weight bold :foreground ,green))))
     `(outline-4  ((t (:weight bold :foreground ,yellow))))
     `(outline-5  ((t (:weight bold :foreground ,orange))))
     `(outline-6  ((t (:weight bold :foreground ,red))))
     ...
     `(isearch ((t (:foreground ,black :background ,orange))))
     ...
     `(artbollocks-lexical-illusions-face ((t (:underline (:color ,orange :style line)))))
